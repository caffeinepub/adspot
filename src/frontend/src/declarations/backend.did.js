...
export const idlService = IDL.Service({
  ...
  'getAdById' : IDL.Func([IDL.Nat], [IDL.Opt(Ad)], ['query']),
  'getAdsByCategory' : IDL.Func([IDL.Text], [IDL.Vec(Ad)], ['query']),
  ...
  'toggleAdActiveStatus' : IDL.Func([IDL.Nat], [], []),
  'updateAd' : IDL.Func(
      [IDL.Nat, IDL.Text, IDL.Text, ExternalBlob, IDL.Text, IDL.Text],
      [],
      [],
    ),
});
