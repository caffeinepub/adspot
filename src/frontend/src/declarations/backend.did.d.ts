...
export interface _SERVICE {
  ...
  'getAdById' : ActorMethod<[bigint], [] | [Ad]>,
  'getAdsByCategory' : ActorMethod<[string], Array<Ad>>,
  ...
  'toggleAdActiveStatus' : ActorMethod<[bigint], undefined>,
  'updateAd' : ActorMethod<
    [bigint, string, string, ExternalBlob, string, string],
    undefined
  >,
}
